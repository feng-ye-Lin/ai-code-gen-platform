  ...
  <div class="logo-page">
    ...
    <div class="content">
      ...
      <div class="description">
        <h1 class="title">零代码应用生成平台</h1>
        <p class="subtitle">快速构建 · 简洁设计 · 高效开发</p>
      </div>
      ...
      <button class="enter-button" @click="enterPlatform">
        进入平台
      </button>
    </div>
...
.background-gradient {
  ...
  bottom: 0;
  background: 
    radial-gradient(circle at 20% 80%, rgba(255, 112, 67, 0.1) 0%, transparent 50%),
