...
import com.yuri.yeaicodegenplatform.langgraph4j.model.enums.ImageCategoryEnum;
...
public class ImageSearchTool {
    ...
    public List<ImageResource> searchContentImages(@P("搜索关键词，需用英文搜索") String query) {
        ...
        try (
            ...
            log.error("Pexels API 请求异常: {}", e.getMessage(), e);
