...
import com.yuri.yeaicodegenplatform.ratelimiter.annotation.RateLimit;
import com.yuri.yeaicodegenplatform.ratelimiter.enums.RateLimitType;
...
public class AppController {
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.yuri.yeaicodegenplatform.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
    ...
    /**
     * 分页查询应用列表（仅管理员，支持根据除时间外的任何字段查询，每页数量不限）
     * @param appQueryRequest 查询请求
     * @return 应用列表
     */
    ...
    public void downloadAppCode(@PathVariable Long appId,
        ...
        // 8. 记录下载次数
        appService.incrementDownloadCount(appId);
    }
